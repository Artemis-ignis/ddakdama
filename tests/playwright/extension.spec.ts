...
test("상세 가격이 늦게 삽입되어도 구매 영역 최종가격만 제한적으로 재확인한다",async({page,extensionId})=>{
 const product:CartFixtureProduct={productId:"720001",vendorItemId:"820001",itemId:"920001",title:"닥터지 레드 블레미쉬 포 맨 진정 올인원 150mL",price:14360,delayedPriceMs:600};
