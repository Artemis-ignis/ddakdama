...
test("쿠팡 URL에 content script가 주입되어 배송비가 아닌 판매가를 구조화한다",async({context,page,extensionWorker})=>{
 await context.route("https://www.coupang.com/np/search**",route=>route.fulfill({status:200,headers:{"content-type":"text/html; charset=utf-8"},body:`<!doctype html><html><head><meta charset="utf-8"></head><body><li><a href="https://www.coupang.com/vp/products/123456?itemId=11&vendorItemId=22"><img alt="스킨1004 히알루 시카 워터핏 선 세럼 50ml, 2개"></a><div class="ProductUnit_productName">스킨1004 히알루 시카 워터핏 선 세럼 50ml, 2개</div><div class="PriceArea_priceArea"><del>32,000원</del><div>30%</div><div>21,800원</div><span>(10ml당 2,180원)</span><div>배송비 3,000원</div><div>최대 218원 적립</div></div><div>로켓배송</div></li></body></html>`}));
