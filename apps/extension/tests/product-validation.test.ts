...
const job={productUrl:"https://www.coupang.com/vp/products/123?itemId=11&vendorItemId=22",productId:"123",vendorItemId:"22",itemId:"11",expectedUnitsPerPackage:2,expectedUnitSize:"50ml",expectedStrength:null,expectedPackageContent:null};
const detail={productId:"123",vendorItemId:"22",itemId:"11",title:"스킨1004 선 세럼 50mL, 2개",price:21800,unitsPerPackage:2,inStock:true,optionRequired:false,securityRequired:false,loginRequired:false};
