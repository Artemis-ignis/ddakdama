# DdakDama Build Week voiceover

The English voiceover used in the revised demo video. It describes the actual flow shown in the capture and explicitly covers both Codex and GPT-5.6.
