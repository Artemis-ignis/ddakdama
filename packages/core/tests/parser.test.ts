...
import {parseShoppingList,planQuantity,cartDeltaMatches,summarizeCartRun,parseExplicitUnitsPerPackage,parseUnitsPerPackage,titleContainsProductIdentity,type CartLineResult} from "../src/index.js";
...
it("브라우저와 파트너스가 사용할 묶음 문구를 동일하게 해석한다",()=>{
 ...
 expect(parseExplicitUnitsPerPackage("선 세럼 50ml 2개")).toBe(2);
 expect(parseExplicitUnitsPerPackage("닭강정 1kg")).toBeNull();
});
